...
namespace GoogleCalendar_App.Service
{
        ...
        public class GoogleCalendarService : IGoogleCalendarService
        {
            ...
            public string GetAuthCode()
            {
                ...
                var redirectURL = "https://localhost:7226/";
                  string prompt = "consent";
                  string response_type = "code";
                    string clientID = "966550470582-lbu6krohu7cc9hk3qc02clugg375537u.apps.googleusercontent.com";
            ...
            public async Task<GoogleTokenResponse> GetTokens(string code)
            {
                ...
                var clientId = "966550470582-lbu6krohu7cc9hk3qc02clugg375537u.apps.googleusercontent.com";
                string clientSecret = "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";
            var redirectURL = "https://localhost:7272/";
                ...
                try
                {
                    ...
                    var credentials = new UserCredential(new GoogleAuthorizationCodeFlow(
                      new GoogleAuthorizationCodeFlow.Initializer
                      {
                          ...
                          {
                              ClientId = "966550470582-lbu6krohu7cc9hk3qc02clugg375537u.apps.googleusercontent.com",
                              ClientSecret = "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"
                          }
